...
description: |
  Event objects are a simple way to implement dosing or other interventions
...
```{r events_setup, echo=FALSE,message=FALSE, include = FALSE}
knitr::opts_chunk$set(echo = TRUE,comment='.',fig.align="center",message=FALSE)
```
